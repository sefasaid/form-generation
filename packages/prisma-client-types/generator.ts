...
function generateIndexFile(models: DMMF.Model[], enums: DMMF.DatamodelEnum[]): string {
...
function generateModelType(model: DMMF.Model, allModels: DMMF.Model[], enums: DMMF.DatamodelEnum[]): string {
...
function mapPrismaTypeToTypeScript(field: DMMF.Field, allModels: DMMF.Model[]): string {
  // Handle relations
...
function generateEnumsFile(enums: DMMF.DatamodelEnum[]): string {
