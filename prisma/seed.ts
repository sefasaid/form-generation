...
const { PrismaClient } = require('../libs/prismaModule/src/generated/client');
const { StepType, Operator, EvaluationResult } = require('../libs/prismaModule/src/generated/enums');
